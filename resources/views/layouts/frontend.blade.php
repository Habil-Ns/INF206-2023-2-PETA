...
<html lang="en">
    <head>
        ...
        @stack('style-alt')
        <title>Pemandu Wisata - PETA</title>
    </head>
    <body>
        <!--==================== HEADER ====================-->
            ...
            <nav class="nav container">
                ...
                <div class="nav__menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item">
                            <a href="{{ route('banda_site.index') }}" class="nav__link {{ request()->is('banda-sites') || request()->is('banda-sites/*')  ? ' active-link' : '' }}">
                                <i class="bx bx-building-house"></i>
                                <span>Wisata Banda Aceh</span>
                            </a>
                        </li>
                        <li class="nav__item">
                ...
                <a target="_blank" href="https://api.whatsapp.com/send?phone=088111444&text=I want to booking" class="button nav__button">Pesan Sekarang</a>
            </nav>
        </header>
